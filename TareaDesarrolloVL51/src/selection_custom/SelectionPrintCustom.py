...
class SelectionPrintTask_Custom(SelectionPrintTask):
    ...
    def label_quantities(self):
        ...
        #FraGon 01112021 Se envia cantidad de etiquetas por LUT desarrollada en VLINK
        lut = VoiceLinkLut('prTaskLUTTotalPrints')
        lut.do_transmit(self._assignment['assignmentID'],self.label_quantities)
        self.next_state = ENTER_PRINTER
