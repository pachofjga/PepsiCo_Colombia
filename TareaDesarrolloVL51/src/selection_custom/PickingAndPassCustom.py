...
class PickingAndPass:
    ...
    #===========================================================================
    #021120221 FraGon Se cambia logica para unificacion LUTS
    #===========================================================================
    ...
    #===========================================================================
    # 02112021 FraGon Se modifica logica de toda la clase para unificacion LUT
    #===========================================================================
    
    def __init__(self, PickingPassLUT=None):
        #FraGon 25052021 Se almacenan LUTS para retornar validaciones posteriores
        if (PickingPassLUT is not None):
            PickingAndPass.PickingAndPastLUT=PickingPassLUT
        
    def isLUTEmpty(self):
        if (PickingAndPass.PickingAndPastLUT is None):
    ...
    def isPrinted(self):
        ...
        #print("Is printed", self.PickingAndPastLUT[0]['isPrinted']=="1", "Isprinted:", self.PickingAndPastLUT[0]['isPrinted'])
    ...
    def isAsgDev(self):
        ...
        #print("Is dev", self.PickingAndPastLUT[0]['assignmentID']!="0", "AssignmentID:", self.PickingAndPastLUT[0]['assignmentID'])
    ...
    def isSplitted(self):
        ...
        #print("Is splitted", self.PickingAndPastLUT[0]['assignmentID']=="1", "AssignmentID:", self.PickingAndPastLUT[0]['assignmentID'])
    ...
    def isBox(self):
        ...
        #print("Is box", self.PickingAndPastLUT[0]['assignmentID']=="2", "isBox:", self.PickingAndPastLUT[0]['assignmentID'])
    ...
    def isPallet(self):
        ...
        #print("Is pallet", self.PickingAndPastLUT[0]['assignmentID']=="3", "isPallet:", self.PickingAndPastLUT[0]['assignmentID'])
    ...
    def isLast(self):
        ...
        #print("Is last", self.PickingAndPastLUT[0]['isLast']=='1')
                #=======================================================================
        # return True if self.check4lastLUT[0]['isLast']=='1' else False
        #=======================================================================
        #02112021 FraGon Se realiza cambio del codigo anterior por unificaciond de LUTS        
        return True if self.PickingAndPastLUT[0]['isLast']=='1' else False
